...
from .bases import departement, commune, commande, objet, utilisateur, role, roleutilisateur
from .db_models import departement_db, commune_db, objet_db, commande_db, client_db, role_db, utilisateur_db, roleutilisateur_db
